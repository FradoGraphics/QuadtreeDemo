...
/*************************************************************/
	...
	typedef void (APIENTRYP pFuncGlDrawArrays)	(GLenum mode, GLint first, GLsizei count);
	typedef void (APIENTRYP pFuncGlLineWidth)		(GLfloat width);
	typedef void (APIENTRYP pFuncGlGetIntegerv)	(GLenum pname, GLint *params);
	typedef void (APIENTRYP pFuncGlDepthRange)	(GLclampd zNear, GLclampd zFar);
	typedef void (APIENTRYP pFuncGlDepthFunc)		(GLenum func);
	typedef void (APIENTRYP pFuncGlEnable)			(GLenum cap);
	typedef void (APIENTRYP pFuncGlViewport)		(GLint x, GLint y, GLsizei width, GLsizei height);
	typedef void (APIENTRYP pFuncGlPolygonMode)	(GLenum face, GLenum mode);
	typedef void (APIENTRYP pFuncGlClearColor)	(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha);
	typedef void (APIENTRYP pFuncGlClear)			(GLbitfield mask);
	typedef void (APIENTRYP pFuncGlDrawElements) (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices);
	typedef void (APIENTRYP pFuncGlPointSize)		(GLfloat size);
	typedef void (APIENTRYP pFuncGlDisable)		(GLenum cap);
	typedef void (APIENTRYP pFuncGlBlendFunc)		(GLenum sfactor, GLenum dfactor);
	typedef const GLubyte * (APIENTRYP pFuncGlGetString) (GLenum name);
#else
